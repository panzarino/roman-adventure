...
<body>
    ...
    <header id="top" class="header" style="background: url(img/farmer.jpg) no-repeat center center scroll;-webkit-background-size: cover;-moz-background-size: cover;background-size: cover;-o-background-size: cover;">
        <div class="text-vertical-center">
            ...
            <?php
            $name = $_GET['name'];
                echo "<p style='font-size:20px'><mark>\"Well Hello, ".$name.". Welcome to Rome\" says the Emperor.<br><br>He gives you a small plot of land right outside of the city in which to grow your grapes.<br>Watch out, if the emperor does not like your grapes you may get in some big trouble.</mark></p>";
                echo '<form class="form-inline" action="emperorservant2.php" method="get">';
