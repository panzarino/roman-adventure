...
<body>
    ...
    <header id="top" class="header" style="background: url(img/legion.jpg) no-repeat center center scroll;-webkit-background-size: cover;-moz-background-size: cover;background-size: cover;-o-background-size: cover;">
        <div class="text-vertical-center">
            ...
            <?php
            $name = $_GET['name'];
            echo "<p style='font-size:20px'><mark>The first battle is tough, but rather than just survive, you thrive.<br>In the fighting your <i>Vexillarius</i> is killed.<br>Since you did so well, you are premoted to the role that he previously held.</mark></p>";
