...
<body>
    ...
    <header id="top" class="header" style="background: url(img/legion.jpg) no-repeat center center scroll;-webkit-background-size: cover;-moz-background-size: cover;background-size: cover;-o-background-size: cover;">
        <div class="text-vertical-center">
            ...
            <?php
            $name = $_GET['name'];
            echo "<p style='font-size:20px'><mark>You have been enlisted as a standard soldier in the Roman Legion<br>If you want to make a name for yourself, you have to pass up through the ranks.</mark></p>";
            echo '<form class="form-inline" action="soldier2.php" method="get">';
