...
<body>
    ...
    <header id="top" class="header" style="background: url(img/farmer.jpg) no-repeat center center scroll;-webkit-background-size: cover;-moz-background-size: cover;background-size: cover;-o-background-size: cover;">
        <div class="text-vertical-center">
            ...
            $num = rand (1, 3);
            if ($num===1 || $num===2){
                echo "<p style='font-size:20px'><mark>You try growing a different type of grape, but the results are the same.<br>Sadly, the emperor does not have a special taste for your grapes.<br>You are able to make a small profit by selling them to poor merchants.</mark></p>";
            ...
            elseif ($num===3){
                echo "<p style='font-size:20px'><mark>You try growing a different type of grape and the emperor loves them<br>He has personally invited you to work for him in Rome.<br><br>Do you accept?</mark></p>";
